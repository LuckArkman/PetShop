...
public class CirurgiaService : ICirurgiaService
{
    ...
    {
        _db = new CirurgiaDBMongo(Singleton.Instance().src, "Cirurgia");
        _db.GetOrCreateDatabase();
    }

    public async Task<object?> GetCirurgia(string _object, CancellationToken cancellationToken)
    {
    ...
    public async Task<object?> InsetCirurgia(Cirurgia _object, CancellationToken cancellationToken)
    {
        var collection = _db.GetDatabase().GetCollection<Cirurgia>("Cirurgia");
    ...
    public async Task<object?> UpdateCirurgia(Cirurgia _object, CancellationToken cancellationToken)
    {
