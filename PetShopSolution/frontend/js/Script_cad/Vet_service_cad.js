...
const div_msg = document.getElementById("div_msg")
    btn_cad.addEventListener("click",async (e)=>{
        e.preventDefault()
        const nome_user = document.getElementById("nome_vet").value
        const email_user = document.getElementById("email_vet").value
        const crmv_user = document.getElementById("crmv_vet").value
        const especialidade_user = document.getElementById("especialidade_vet").value
        const telefone_user = document.getElementById("telefone_vet").value
        const senha_user = document.getElementById("senha_vet").value
        const confirm_senha_user = document.getElementById("confirm_senha_vet").value
