// ===================== MODAIS =====================
const modal_user = document.getElementById("backdropSimplerec")
const modal_user_edit = document.getElementById("backdropSimpleuseredit")

const form_user = document.getElementById("form_recep")
const form_user_edit = document.getElementById("form_user_edit")

const btn_add_user = document.getElementById("btn_add_rec")
const btn_cancel_user = document.getElementById("cancelSimplerec")
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        const req_users = await fetch("https://petrakka.com:7231/api/Atendente/Atendentes")
        ...
        res_user.forEach(user => {
            ...
            btn_edit.addEventListener("click", () => {
                ...
                document.getElementById("fNameuseredit").value = user.nome || ""
            ...
            btn_delete.addEventListener("click", async () => {
                ...
                try {
                    const req = await fetch(`https://petrakka.com:7231/api/Atendente/delete?mail=${user.email}`, {
                        method: "DELETE",
...
btn_cad.addEventListener("click", async (e) => {
    ...
    const data = {
        Email: document.getElementById("fEmailrec").value,
        Password: document.getElementById("fsenharec").value,
        ConfirmPassword: document.getElementById("fConsenharec").value,
        nome: document.getElementById("fNamerec").value,
        RG: document.getElementById("fRgrec").value
        }
...
btn_save_user_edit.addEventListener("click", async (e) => {
    ...
    const data = {
        id: USER_ID_EDIT,
        nome: document.getElementById("fNameuseredit").value,
    ...
    try {
        const req = await fetch("https://petrakka.com:7231/api/Atendente/update", {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(data)
        })
