...
public class AnimalGeolocationHistoryDB
{
    IMongoClient client;
    string databaseName;
    IMongoDatabase _database;
    public AnimalGeolocationHistoryDB()
    {
        
    }

    public AnimalGeolocationHistoryDB(string connectionString, string _databaseName)
    {
